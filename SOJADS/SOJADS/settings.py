"""
Django settings for SOJADS project.
...
SECRET_KEY = 'django-insecure-@n&$in(8m4vm$g0e&rblvige2(ltp3**#l*0&l7og8j$_!jnyv'
...
WSGI_APPLICATION = 'SOJADS.wsgi.application'
